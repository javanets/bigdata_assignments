...
def get_paths():
    ...
    paths.INITIAL_TARGET_PATH = "//home/student/assignments/search_dau/output"
    paths.TEST_DIR = f"//home/student/__testdata__/module_03/02_search_dau/tmp-{get_session_id()}"
