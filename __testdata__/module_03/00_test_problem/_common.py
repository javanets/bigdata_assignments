...
def get_paths():
    ...
    paths.INITIAL_TARGET_PATH = "//home/student/assignments/churned_in_may/output"
    paths.TEST_DIR = f"//home/student/__testdata__/module_03/00_test_problem/tmp-{get_session_id()}"
