...
def get_paths():
    ...
    paths.INITIAL_TARGET_PATH = "//home/student/assignments/checkout_freq/output"
    paths.TEST_DIR = f"//home/student/__testdata__/module_03/01_checkout_freq/tmp-{get_session_id()}"
